...
```{r comparemodels3, include=TRUE, message = FALSE, fig.cap = "Graphical comparison of the difference between the sample probabilities and the predicted probabilities."}
sampleprob <- A[A$model == "data", c('race', 'resp','probability')] %>% rename(prob = probability)
A %>% filter(model != "data") %>%
