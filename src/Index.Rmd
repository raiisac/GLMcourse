...
The red line in Figure \@ref(fig: GOF1), which represents the observed variance, is significantly larger than what we would expect under the model. This indicates the presence of overdispersion. 
